...
export default function ProductHuntFeed({ widgetId, widgetConfig }: ProductHuntFeedProps) {
  ...
  return (
    ...
    >
      {(products) => {
        // Compact view - show only top 3 products with minimal info
        if (viewMode === "compact") {
          return (
                ...
                <div key={product.id} className="flex items-center justify-between text-xs">
                  <div className="flex-1 min-w-0">
                    <a
                      ...
                      className="block truncate font-medium text-gray-900 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400"
                    >
                  ...
                  <div className="ml-2 flex items-center text-gray-500 dark:text-gray-400">
                    <svg className="w-3 h-3 mr-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <title>Votes</title>
                      <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z" />
                    </svg>
                    <span className="font-medium">{product.votesCount}</span>
                  </div>
                </div>
              ))}
